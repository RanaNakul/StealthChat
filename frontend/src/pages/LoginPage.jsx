              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm opacity-70">
                    Sign in to your account to continue your chatting journey
                  </p>
                </div>
                  ...
                  <div className="form-control w-full space-y-2 relative">
                    <div className=" flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="label-text text-primary hover:underline cursor-pointer"
                      >
                        Forgot Password?
                      </button>
                    </div>
                    ...
                    <div
                      ...
                      className="absolute right-3 top-10 cursor-pointer z-30 "
                    >
                      {showPassword ? (
